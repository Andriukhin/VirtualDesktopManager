...
//
  CLSID_ApplicationViewCollection: TGUID = '{2C08ADF0-A386-4B35-9250-0FE183476FCC}'; // <--- CLSID same as IID? not shure, but it's works
  IID_ApplicationViewCollection: TGUID = '{2C08ADF0-A386-4B35-9250-0FE183476FCC}';
//
